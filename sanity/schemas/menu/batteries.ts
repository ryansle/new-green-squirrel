...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      title: 'Brand',
      type: 'string',
      description: 'What brand battery is this?',
    ...
    defineField({
      ...
      title: 'Description',
      type: 'string',
      description: 'Describe the product. Keep it short.',
      validation: (Rule) => Rule.required(),
    }),
    defineField({
      name: 'image',
      title: 'Image',
      type: 'image',
      description: 'An image of the battery.',
      validation: (Rule) => Rule.required(),
    }),
    defineField({
      name: 'price',
      title: 'Price',
      type: 'string',
      description: 'The price of the battery to be sold at.',
      validation: (Rule) => Rule.required(),
    }),
    defineField({
      name: 'new',
